...
#    results/ngs/GSE310664/tables/<analysis_name>/DEG/significant_genes.csv
# 2. 02号脚本生成的每套交集基因列表：
#    results/ngs/GSE310664/intersect/<intersection_scheme>/gene_list.csv
#
# 注意：
...
#
# 输出：
# results/ngs/GSE310664/TF/DEG/<analysis_name>/<method>/
# results/ngs/GSE310664/TF/intersect/<intersection_scheme>/<method>/
...
ANALYSES_TO_RUN <- "all"
# ANALYSES_TO_RUN <- c("CRC29_p27_high", "HUB098_p27_high")
