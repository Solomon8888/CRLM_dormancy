...
DE_SCRIPT_FILE <- "scripts/GSE310664/01_limma_differential_expression.R"
...
#   p27_all_cell_lines = c("CRC29_p27_high", "HUB098_p27_high", "TOR10_p27_high")
# )
MULTIPLE_VOLCANO_SCHEMES <- "auto_all"

# 运行哪些多组火山图方案。默认"all"表示运行MULTIPLE_VOLCANO_SCHEMES中的全部方案。
SCHEMES_TO_RUN <- "all"
# SCHEMES_TO_RUN <- c("p27_all_cell_lines")
...
# CUSTOM_LABEL_GENES <- list(all = c("ATF3"), CRC29_p27_high = c("CDKN1B"))
