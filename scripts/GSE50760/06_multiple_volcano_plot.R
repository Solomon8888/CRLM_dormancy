# GSE50760 multiple volcano plots.
#
# Combines main tissue DE and within-tissue ATF3 high/low DE results into
# separate multi-panel volcano plots.
...
MULTIPLE_VOLCANO_SCHEMES <- list(
  MAIN_TISSUE_CONTRASTS = c(
    "Main_DE::Liver_metastasis_vs_normal",
    "Main_DE::Liver_metastasis_vs_primary",
    "Main_DE::Primary_tumor_vs_normal"
  ),
  ATF3_HIGH_LOW_TISSUES = c(
    "ATF3_high_low_DE::Liver_metastasis",
    "ATF3_high_low_DE::Primary_tumor",
    "ATF3_high_low_DE::Normal_colon"
  )
)
...
GROUP_LABEL_COLORS <- c(
  "Liver_metastasis_vs_normal" = "#c70008",
  "Liver_metastasis_vs_primary" = "#eb7400",
  "Primary_tumor_vs_normal" = "#0052a2",
...
# 2. Sync thresholds and check inputs -----------------------------------------

SCHEMES_TO_RUN <- parse_env_vector(
  "GSE50760_MULTIPLE_VOLCANO_SCHEMES",
...
cat("\nRunning GSE50760 multiple volcano plot generation...\n")
...
cat("\nGSE50760 multiple volcano plot generation finished.\n")
